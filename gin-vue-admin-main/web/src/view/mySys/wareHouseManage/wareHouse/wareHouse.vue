<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="仓库名字" prop="wareHouseName" width="120" />
    ...
    <el-drawer size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="仓库名字:"  prop="wareHouseName" >
              <el-input v-model="formData.wareHouseName" :clearable="true"  placeholder="请输入仓库名字" />
            </el-form-item>
          </el-form>
    </el-drawer>
    ...
    <el-drawer size="800" v-model="detailShow" :before-close="closeDetailShow" destroy-on-close>
        ...
        <el-descriptions :column="1" border>
                <el-descriptions-item label="仓库名字">
